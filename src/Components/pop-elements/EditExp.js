    ...
    <div className="fixed left-0 top-0 bg-[#FFFFFFC4] h-screen w-full flex justify-center items-center">
      <div className="h-2/5 w-2/5 bg-[#EFEFEFD9] flex justify-center items-center rounded-lg">
        <form onSubmit={submitHandler} className="h-64 w-11/12  p-5 gap-5">
          <p className="text-2xl text-black font-bold">Edit Expense</p>
          <div className="flex justify-between flex-wrap h-full w-full mt-2 gap-">
            ...
            <div className="w-full flex justify-between gap-20">
              <div className="w-1/2 ">
                <button
                  type="submit"
                  className="bg-yellow-500 h-12 w-56 rounded-md  drop-shadow-md text-white font-semibold"
                >
                  Add Balance
                </button>
              </div>
              <div className="w-1/2">
                <button
                  ...
                  className="bg-[#D9D9D9] h-12 w-28 rounded-md  drop-shadow-md text-black font-semibold"
                >
                  Cancel
                </button>
              </div>
